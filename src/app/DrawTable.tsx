...
import { constructionParts, FORMS_FOR_PART, itemRoute, MATERIAL_LABEL, MATERIALS_FOR_PART, profilePrompt, supportsFor, VIEW_LABEL, type PartKit } from '../draw/construction'
