...
import { constructionParts, FORMS_FOR_PART, itemRoute, MATERIAL_LABEL, MATERIALS_FOR_PART, VIEW_LABEL, VIEW_PROMPT, type PartKit } from '../draw/construction'
