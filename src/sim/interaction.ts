...
import { shelfNearby } from '../world/ShoreShelf'
...
export function getInteractionTarget(): InteractionTarget | null {
  ...
  if (shelfNearby()) { const n = g.treasures.length; return { id: 'shore-shelf', label: 'Shore Finds shelf', detail: n ? `E admire · ${n}/7 found` : 'E look at the empty shelf', verb: 'talk' } }
